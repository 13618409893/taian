...
/*
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `lt_auth_group`;
  CREATE TABLE `lt_auth_group` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  ...
  -- ----------------------------
  -- lt_auth_group_access 用户组明细表
  -- uid:用户id，group_id：用户组id
  -- ----------------------------
  DROP TABLE IF EXISTS `lt_auth_group_access`;
  CREATE TABLE `lt_auth_group_access` (
